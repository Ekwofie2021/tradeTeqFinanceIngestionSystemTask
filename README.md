...
- Seed data - 5 notes and 10 instruments ready to go
...
**InMemory Database** - Zero setup. Just run it. The app seeds itself with 5 notes and 10 instruments automatically.
